...
- [x] Rendered outside the `site-header` view-transition group, with a named `breadcrumbs` group whose snapshots are hidden, so add/exit GSAP plays live on navigation
