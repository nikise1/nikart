...
- Temporary Ruffle vs AwayFL compare kit: `npm run swf-compare:sync` copies SWFs locally; one HTML page per SWF with generic players; menu/popWin open `/swf-compare/` instead of the popup.
