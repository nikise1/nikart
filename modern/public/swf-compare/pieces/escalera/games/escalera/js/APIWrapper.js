...
//var _Debug = true;	// and get rid of those annoying alert boxes.
...
/*******************************************************************************
**
** Function: alertTrace(str)
** Inputs:  str - String to output to an alert box
** Return:  None
**
** Description:
** alert(str) if the variable _Debug is true. To enable or disable alerts easily.
** Added by Niki Sehmi - nikart.co.uk
**
*******************************************************************************/
function alertTrace(str)
{
...
function doLMSInitialize()
{
   ...
   if (api == null)
   {
      alertTrace("Unable to locate the LMS's API Implementation.\nLMSInitialize was not successful.");
      return "false";
   }
...
function doLMSGetValue(name)
{
   ...
   else
   {
      ...
      if (errCode != _NoError)
      {
         ...
         alertTrace("LMSGetValue("+name+") failed. \n"+ errDescription);
         return "";
      }
      else
      {
...
function findAPI(win)
{
   while ((win.API == null) && (win.parent != null) && (win.parent != win))
   {
      ...
      if (findAPITries > 7) 
      {
         alertTrace("Error finding API -- too deeply nested.");
         return null;
      }
...
function getAPI()
{
   ...
   if (theAPI == null)
   {
      alertTrace("Unable to find an API adapter");
   }
   return theAPI
}
